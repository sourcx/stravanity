  ...
  if (req.query.code && typeof req.query.code === 'string') {
    try {
      ...
      res.setHeader('Set-Cookie', [
        serialize('access_token', payload.access_token, {
          expires: new Date(payload.expires_at * 1000),
          path: '/',
          samesite: 'none',
        }),
        serialize('refresh_token', payload.refresh_token, {
      ...
      // Clear cookies
      res.setHeader('Set-Cookie', [
        serialize('access_token', '_', {
          expires: new Date(0),
          path: '/',
          samesite: 'none',
        }),
        serialize('refresh_token', '_', {
          expires: new Date(0),
          path: '/',
          samesite: 'none',
        }),
